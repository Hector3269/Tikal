...
impl SqlGenerator for SqlGeneratorEnum {
    fn generate_select<E: Entity>(
        &self,
        builder: &QueryBuilder<E>,
    ) -> (String, Vec<crate::domain::value_objects::Value>) {
        match self {
    ...
    fn generate_create_table(
        &self,
        table: &crate::infrastructure::schema::TableDefinition,
    ) -> String {
        match self {
